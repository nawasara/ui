        ...
        <div class="p-1 space-y-0.5">
            @foreach ($items as $value => $text)
                ...
                <button type="button"
                    ...
                    {{ $isSelected ? 'bg-emerald-50 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-800 dark:text-neutral-400' }}">
                    @if ($isSelected)
                        <svg class="shrink-0 size-4 text-emerald-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
